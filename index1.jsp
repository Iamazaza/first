...
<script type="text/javascript">
	...
	$(function(){
		...
		//展示市场活动页面
		window.open("jsp/main/index.jsp","workareaFrame");
...
<body>
 <!-- 我的资料 -->
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='jsp/login.jsp';">更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='jsp/login.jsp';">确定</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">欢迎进入药品管理信息系统 &nbsp;<span style="font-size: 12px;">&copy;2017&nbsp;李玉婷</span></div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						...
						<!-- <li><a href="javascript:void(0)" data-toggle="modal" data-target="#editPwdModal"><span class="glyphicon glyphicon-edit"></span> 登录</a></li> -->
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<li class="liClass"><a href="jsp/main/index.html" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
				...
				<li class="liClass"><a href="jsp/activity/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-tag"></span> 药品管理</a></li>
				<!-- <li class="liClass"><a href="jsp/activity/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-time"></span> 售药</a></li> -->
				<li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 库存查询</a></li>
				<li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span class="glyphicon glyphicon-file"></span> 进药查询</a></li>
				<li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span class="glyphicon glyphicon-shopping-cart"></span> 售药查询</a></li>
